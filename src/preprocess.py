...
class DataPreProcess(object):
  ...
  def _save_data(self):
    ...
    utils.save_data_to_pkl(
        self.x_train, join(self.preprocessed_path, 'imgs_train.p'))
    utils.save_data_to_pkl(
        self.x_valid, join(self.preprocessed_path, 'imgs_valid.p'))
    utils.save_data_to_pkl(
        self.x_test, join(self.preprocessed_path, 'imgs_test.p'))
